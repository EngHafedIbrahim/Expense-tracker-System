...
1. **Configure database connection**Edit `includes/config.php` and update:
...
1. Click "إنشاء الحساب" (Create Account)
...
1. Click "إضافة مصروف" (Add Expense)
...
1. Create, edit, or delete categories

1. Assign colors and icons to categories
...
1. Track your spending against the budget

### Viewing Reports

1. Go to "التقارير" (Reports)

1. View expense breakdowns by category

1. See monthly trends and statistics
...
1. Include the header: `require_once 'includes/header.php';`

1. Add your content

1. Include the footer: `require_once 'includes/footer.php';`

1. Add navigation link in `includes/header.php`
...
**Version**: 1.0.0**Last Updated**: May 2026**Language**: Arabic (RTL) + English**Status**: Production Ready
