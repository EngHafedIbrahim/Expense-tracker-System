...
$budget = $budgetResult->num_rows > 0 ? $budgetResult->fetch_assoc()['budgetAmount'] : 0;
...
<div class="app-content">
    <div class="page-title">
        <div>
            <h1>لوحة التحكم</h1>
            <p class="page-description">نظرة سريعة على النفقات والميزانية الخاصة بك.</p>
        </div>
        ...
        <div class="hero-card">
            <div class="hero-grid">
                <div>
                    ...
                    <p>إليك ملخص نفقاتك الشهرية والميزانية المتبقية. يمكنك إدارة مصروفك وتتبع إنفاقك بسرعة ودقة.</p>
                </div>
